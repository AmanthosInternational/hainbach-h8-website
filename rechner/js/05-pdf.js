  ...
  function inhalt(eingaben, ergebnis, jetzt) {
    return [
      ...
      { schluessel: 'ergebnis', titel: 'Ergebnis nach ' + K.STEUER.betrachtungJahre + ' Jahren', zeilen: [
        ...
        ['Faktor auf das Eigenkapital', zahl(ergebnis.faktor, 2, 2)], ['Eigenkapitalrendite p. a., interner Zinsfuss', zahl(ergebnis.irrProzent, 2, 2) + ' %'],
        ['Cashflow nach Kreditrate und Steuern, Jahr 1', eur(ergebnis.cashflowNachSteuerMonatJahr1) + ' im Monat'],
